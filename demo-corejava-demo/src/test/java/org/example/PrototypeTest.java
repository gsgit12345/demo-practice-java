...
import org.example.designpattern.creational.Prototype.prototypewithoutclone.MangoTree;
import org.example.designpattern.creational.Prototype.prototypewithoutclone.AppleTree;
...
public class PrototypeTest
{
    ...
    public void givenA_ListOfTreesWhenClonedThenCreateListOfClones() {
        double mass = 10.0;
        double height = 3.7;
        AppleTree plasticTree = new AppleTree(mass, height);
        MangoTree pineTree = new MangoTree(mass, height);
